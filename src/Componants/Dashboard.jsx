...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      {/* Card up schol*/}
      <div className=" cursor-pointer grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:items-center justify-center gap-4 pt-12 p-4 overflow-x-auto bg-gradient-to-tl from-[#a2a4a3]  to-[#000000] ">
        ...
        {/* BANK FINANNCE */}
        <div onClick={() => navigate('/Banking')} className="cursor-pointer bg-gradient-to-br from-[#2dd4bf]  to-[#1f2937] rounded-4xl text-white h-[120px] p-4 flex  items-center">
        ...
        {/* Aadhar  */}
        <div className="cursor-pointer bg-gradient-to-t from-[#b3fdfd]  to-[#015b47] rounded-4xl text-white h-[120px] p-4 flex  items-center">
        ...
        {/* Pan card */}
        <div className="cursor-pointer bg-gradient-to-tl from-[#81abed]  to-[#2f0449] rounded-4xl text-white h-[120px] p-4 flex  items-center">
        ...
        {/* photoshoot card */}
        <div className=" cursor-pointer bg-gradient-to-tr from-[#86ffb2]  to-[#563d26] rounded-4xl text-white h-[120px] p-4 flex  items-center">
        ...
        {/* PrintOut card */}
        <div className=" cursor-pointer bg-gradient-to-b from-[#ffffff]  to-[#8889c5] rounded-4xl text-white h-[120px] p-4 flex  items-center">
        ...
        {/* PGoverment form */}
        <div className="cursor-pointer bg-gradient-to-t from-[#c260d8]  to-[#7f1d1d45] rounded-4xl text-white h-[120px] p-4 flex  items-center">
        ...
        {/* cast certificat */}
        <div className="cursor-pointer bg-gradient-to-l from-[#06b6d4]  to-[#ebfff2] rounded-4xl text-white h-[120px] p-4 flex  items-center">
        ...
        {/* income certificat */}
        <div className=" cursor-pointer bg-gradient-to-b from-[#818cf8]  to-[#ffffff] rounded-4xl text-white h-[120px] p-4 flex items-center">
        ...
        {/* Living certificat */}
        <div className=" cursor-pointer bg-gradient-to-l from-[#5d5d87]  to-[#320f1d] rounded-4xl text-white h-[120px] p-4 flex  items-center">
          <img src={live} className=' w-24 h-24  rounded-full bg-[#205866]  p-2' />
          <h2 className='text-black font-sans text-2xl ml-2 font-semibold'> Domicile Certificate</h2>
        </div>
      </div>
